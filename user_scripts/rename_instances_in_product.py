...
def message_box(_caa: Application):
    ...
    """
    mb = _caa.message_box(
        "Please select product whose children's instances you would like renaming sequentially.",
        buttons=1,
...
def get_selected_item(_document: Document):
    ...
    try:
        selection.select_element2(filter_, message, True)
...
def rename_products(reference_products: Products, tmp_name: str or False = False):
    """
