...
from .settings import border_offset, company_details, logo, tolerances, units
from .text_properties import set_text_properties


def add_title_block_text(
    texts: DrawingTexts,
    text: str,
    text_x: float,
    text_y: float,
...
def add_param_text(
    ...
    p_ticket = parameters.get_item(rf"Drawing\{param_variable}")
...
def create_title_block(
    ...
    h1 = {
        "x_start": bottom_left_hand_corner_x,
        "x_end": bottom_left_hand_corner_x + title_block_width,
    ...
    h5 = {
        "x_start": bottom_left_hand_corner_x,
        "x_end": bottom_left_hand_corner_x + title_block_width,
        "y": bottom_left_hand_corner_y + line_height * 7,
    }  # top horizontal line

    # dims for complete vertical lines
    v1 = {
        "x": bottom_left_hand_corner_x,
        "y_start": bottom_left_hand_corner_y,
        "y_end": bottom_left_hand_corner_y + title_block_height,
    }  # first vertical line
    v2_x_offset = 65
    v2 = {
        "x": bottom_left_hand_corner_x + v2_x_offset,
        "y_start": bottom_left_hand_corner_y,
        "y_end": bottom_left_hand_corner_y + title_block_height,
    }
    v3_x_offset = 138
    v3 = {
        "x": bottom_left_hand_corner_x + v3_x_offset,
        "y_start": bottom_left_hand_corner_y,
        "y_end": bottom_left_hand_corner_y + title_block_height,
    }
    v4 = {
        "x": bottom_left_hand_corner_x + title_block_width,
        "y_start": bottom_left_hand_corner_y,
        "y_end": bottom_left_hand_corner_y + title_block_height,
    }
    ...
    v1_1 = {
        "x": v1_1_x_offset,
        "y_start": bottom_left_hand_corner_y + line_height * 3,
        "y_end": bottom_left_hand_corner_y + title_block_height,
    }
    ...
    v3_1 = {
        "x": v3_1_x_offset,
        "y_start": bottom_left_hand_corner_y + line_height,
    ...
    v3_2 = {
        "x": v3_2_x_offset,
        "y_start": bottom_left_hand_corner_y,
        "y_end": bottom_left_hand_corner_y + line_height,
    }
    ...
    h3_2_y_offset = (
        bottom_left_hand_corner_y + (line_height * 3) + ((line_height * 2) / 3)
    )
    ...
    line_iph_2_1 = factory_2d.create_line(
        h2_1["x_start"], h2_1["y"], h2_1["x_end"], h2_1["y"]
    )
    line_iph_2_1.name = f"{line_iph_2_1=}".split("=")[0]

    line_iph_3_1 = factory_2d.create_line(
        h3_1["x_start"], h3_1["y"], h3_1["x_end"], h3_1["y"]
    )
    line_iph_3_1.name = f"{line_iph_3_1=}".split("=")[0]

    line_iph_3_2 = factory_2d.create_line(
        h3_2["x_start"], h3_2["y"], h3_2["x_end"], h3_2["y"]
    )
    line_iph_3_2.name = f"{line_iph_3_2=}".split("=")[0]

    line_iph_3_3 = factory_2d.create_line(
        h3_3["x_start"], h3_3["y"], h3_3["x_end"], h3_3["y"]
    )
    line_iph_3_3.name = f"{line_iph_3_3=}".split("=")[0]

    line_iph_4_1 = factory_2d.create_line(
        h4_1["x_start"], h4_1["y"], h4_1["x_end"], h4_1["y"]
    )
    ...
    line_ipv_1_1 = factory_2d.create_line(
        v1_1["x"], v1_1["y_start"], v1_1["x"], v1_1["y_end"]
    )
    line_ipv_1_1.name = f"{line_ipv_1_1=}".split("=")[0]

    line_ipv_2_1 = factory_2d.create_line(
        v2_1["x"], v2_1["y_start"], v2_1["x"], v2_1["y_end"]
    )
    line_ipv_2_1.name = f"{line_ipv_2_1=}".split("=")[0]

    line_ipv_2_2 = factory_2d.create_line(
        v2_2["x"], v2_2["y_start"], v2_2["x"], v2_2["y_end"]
    )
    line_ipv_2_2.name = f"{line_ipv_2_2=}".split("=")[0]

    line_ipv_3_1 = factory_2d.create_line(
        v3_1["x"], v3_1["y_start"], v3_1["x"], v3_1["y_end"]
    )
    line_ipv_3_1.name = f"{line_ipv_3_1=}".split("=")[0]

    line_ipv_3_2 = factory_2d.create_line(
        v3_2["x"], v3_2["y_start"], v3_2["x"], v3_2["y_end"]
    )
    line_ipv_3_2.name = f"{line_ipv_3_2=}".split("=")[0]

    line_ipv_3_3 = factory_2d.create_line(
        v3_3["x"], v3_3["y_start"], v3_3["x"], v3_3["y_end"]
    )
    line_ipv_3_3.name = f"{line_ipv_3_3=}".split("=")[0]

    line_ipv_3_4 = factory_2d.create_line(
        v3_4["x"], v3_4["y_start"], v3_4["x"], v3_4["y_end"]
    )
    ...
    add_title_block_text(
        texts, "INTERPRET DRAWING PER BS 8888:2011", text_x, text_y, size=2
    )
    ...
    unit_text_1 = add_title_block_text(
        texts, "UNLESS OTHERWISE SPECIFIED", text_x, text_y
    )
    text_y = h4["y"] + text_y_offset + 1
    unit_text_1 = add_title_block_text(
        texts, f"DIMENSIONS ARE IN {units[1]}", text_x, text_y
    )
    ...
    add_param_text(
        ...
        parameters,
        "TICKET",
        v1_1["x"] + text_x_offset,
        h4_1["y"] + text_y_offset,
    )
    add_param_text(
        texts,
        parameters,
    ...
    add_param_text(
        ...
        "APPROVED-BY",
        v1_1["x"] + text_x_offset,
        h3_1["y"] + text_y_offset,
    )
    add_param_text(
        texts, parameters, "DATE", v1_1["x"] + text_x_offset, h3["y"] + text_y_offset
    )
    # title
    title_x = (v3_1["x"] + v4["x"]) / 2
    title_text = add_param_text(
        texts, parameters, "TITLE", title_x, h3["y"] + text_y_offset, size=4
    )
    ...
    add_param_text(
        ...
        parameters,
        "REVISION",
        v3_4["x"] + text_x_offset + 0.25,
        h2["y"] + text_y_offset,
        size=4,
    )
    add_param_text(texts, parameters, "SCALE", v3_2["x"] + 15, h1["y"] + text_y_offset)
    add_param_text(
        texts, parameters, "TOTAL-SHEETS", v3_3["x"] + 25, h1["y"] + text_y_offset
    )
    # sheet number
    sheet_number_text = add_title_block_text(
        texts, str(sheet_number), v3_3["x"] + 11, h1["y"] + text_y_offset
    )
