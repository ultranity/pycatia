...
from .settings import border_offset, company_details
...
def create_copyright_box(sheet: DrawingSheet, parameters: Parameters):
    ...
    box_height = 30
    box_width = 130
    top_line = factory_2d.create_line(
        border_offset,
        border_offset + box_height,
        border_offset + box_width,
        border_offset + box_height,
    )
    right_line = factory_2d.create_line(
        border_offset + box_width,
        border_offset,
        border_offset + box_width,
        border_offset + box_height,
    ...
    text_l1 = "COPYRIGHT OF THIS DRAWING SPECIFICATION DOCUMENT, WHICH IS SUPPLIED"
    text_l2 = "IN CONFIDENCE AND WHICH, WITHOUT THE EXPRESS WRITTEN CONSENT OF"
    text_l3 = f"{company_details['name']} MUST NOT BE USED FOR ANY PURPOSE OTHER THAN "
    text_l4 = "THAT FOR WHICH IT IS SUPPLIED, MUST NOT BE REPRODUCED IN ANY WAY IN "
    text_l5 = "WHOLE OR IN PART NOR LOANED TO ANY THIRD PARTY NOR MUST THE "
    text_l6 = "INFORMATION CONTAINED THEREIN BE REPRODUCED OR LOANED IN WHOLE OR "
    text_l7 = "IN PART. "
    text_l8 = "ALL RIGHTS RESERVED. COPYRIGHT ."
    ...
    p_year = parameters.get_item(r"Drawing\YEAR")
