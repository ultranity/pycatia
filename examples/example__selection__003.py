...
doc: PartDocument = caa.active_document
part = doc.part
...
mb = caa.message_box(
    "Select any HybridShape, or PartBody.\n"
...
selected = selection.select_element2(
    cat_selection_filter, "Select a HybridShape or PartBody.", True
)
...
text = f"selection_name={sel_name}\nparent={parent_name}\nbase_geom_type={base_geom_type}\naddition_geom_type={add_geom_type}"
