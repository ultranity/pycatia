...
class RpmReport(AnyObject):
    ...
    def generate_report(
        self,
        i_xml_file_name: str,
        i_report_file_name: str,
        i_report_type: str,
        i_out_dtd_file_name: str,
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.rpm_report.GenerateReport(
            i_xml_file_name, i_report_file_name, i_report_type, i_out_dtd_file_name
        )
