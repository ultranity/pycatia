...
class Sketch(AnyObject):
    ...
    def center_line(self, value: Line2D):
        ...
        self.sketch.CenterLine = value.com_object
    ...
    def to_dict(self):
        return super().to_dict() | {
            "absolute_axis": self.absolute_axis.to_dict(),
            "center_line": self.center_line.to_dict() if self.center_line else None,
            "constraints": self.constraints.to_dict(),
            "geometric_elements": self.geometric_elements.to_dict(),
        }
