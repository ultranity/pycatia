...
class MhiRelationManagement(AnyObject):
    ...
    def get_relation_object(
        self, i_relation_name: str, i_assigned_object: AnyObject
    ) -> AnyObject:
        """
        .. note::
            :class: toggle
        ...
        :rtype: AnyObject
        """
        return self.mhi_relation_management.GetRelationObject(
            i_relation_name, i_assigned_object.com_object
        )
