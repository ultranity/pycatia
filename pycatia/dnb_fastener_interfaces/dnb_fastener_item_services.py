...
class DnbFastenerItemServices(AnyObject):
    ...
    def assign_fastener_to_process(
        self, i_fastener: Fastener, i_process: Activity, e_status: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.dnb_fastener_item_services.AssignFastenerToProcess(
            i_fastener.com_object, i_process.com_object, e_status
        )
    ...
    def assign_fastener_to_resource(
        self, i_fastener: Fastener, i_resource: Resource, e_status: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        return self.dnb_fastener_item_services.AssignFastenerToResource(
            i_fastener.com_object, i_resource.com_object, e_status
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def get_fasteners(
        self, i_products: tuple, b_joining_fasteners: bool, o_fastener_array: tuple
    ) -> list:
        """
        .. note::
            :class: toggle
        ...
        :rtype: AnyObject
        """
        return self.dnb_fastener_item_services.GetFasteners(
            i_products, b_joining_fasteners, o_fastener_array
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def get_fasteners_from_process(
        self, i_operation: Activity, i_fasteners: FastenerSet
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.dnb_fastener_item_services.GetFastenersFromProcess(
            i_operation.com_object, i_fasteners.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def get_fasteners_from_resource(
        self, i_resource: Resource, i_fasteners: FastenerSet
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.dnb_fastener_item_services.GetFastenersFromResource(
            i_resource.com_object, i_fasteners.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def get_number_of_fasteners(
        self, i_products: tuple, b_joining_fasteners: bool
    ) -> int:
        """
        .. note::
            :class: toggle
        ...
        :rtype: int
        """
        return self.dnb_fastener_item_services.GetNumberOfFasteners(
            i_products, b_joining_fasteners
        )

    def remove_fastener_from_process(
        self, i_fastener: Fastener, i_process: Activity
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.dnb_fastener_item_services.RemoveFastenerFromProcess(
            i_fastener.com_object, i_process.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def remove_fastener_from_resource(
        self, i_fastener: Fastener, i_resource: Resource
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.dnb_fastener_item_services.RemoveFastenerFromResource(
            i_fastener.com_object, i_resource.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
