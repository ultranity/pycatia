...
class DnbFastenerNewMfgPosServices(AnyObject):
    ...
    def get_flagged_fasteners(self, o_fastener_array: tuple) -> None:
        ...
        :rtype: None
        """
        return self.dnb_fastener_new_mfg_pos_services.GetFlaggedFasteners(
            o_fastener_array
        )
    ...
    def set_flag_on_fasteners(self, i_fastener_array: tuple) -> None:
        ...
        :rtype: None
        """
        return self.dnb_fastener_new_mfg_pos_services.SetFlagOnFasteners(
            i_fastener_array
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
    ...
    def unset_flag_on_fasteners(self, i_fastener_array: tuple) -> None:
        ...
        :rtype: None
        """
        return self.dnb_fastener_new_mfg_pos_services.UnsetFlagOnFasteners(
            i_fastener_array
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
