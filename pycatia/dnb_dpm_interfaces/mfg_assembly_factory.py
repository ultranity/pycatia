...
class MfgAssemblyFactory(AnyObject):
    ...
    def create_mfg_assembly(
        self, i_name_bstr: str, i_part_number_bstr: str, i_type: int
    ) -> Item:
        """
        .. note::
            :class: toggle
        ...
        """
        return Item(
            self.mfg_assembly_factory.CreateMfgAssembly(
                i_name_bstr, i_part_number_bstr, i_type
            )
        )
    ...
    def get_number_of_all_mfg_assy(
        self, i_type: int, o_num_of_mfg_assemblies: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.mfg_assembly_factory.GetNumberofALLMfgAssy(
            i_type, o_num_of_mfg_assemblies
        )
    ...
    def retrieve_mfg_assembly(
        self, i_name_bstr: str, o_mfg_assemblies: tuple, o_num_of_mfg_assemblies: int
    ) -> AnyObject:
        """
        .. note::
            :class: toggle
        ...
        return AnyObject.new(
            self.mfg_assembly_factory.RetrieveMfgAssembly(
                i_name_bstr, o_mfg_assemblies, o_num_of_mfg_assemblies
            )
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
    ...
    def retrive_all_mfg_assy(
        self, i_type: int, o_all_m_as: tuple, o_num_of_mfg_assemblies: int
    ) -> AnyObject:
        """
        .. note::
            :class: toggle
        ...
        """
        return AnyObject.new(
            self.mfg_assembly_factory.RetriveALLMfgAssy(
                i_type, o_all_m_as, o_num_of_mfg_assemblies
            )
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
