...
class ManufacturingSurfaceMachiningArea(ManufacturingMachinableArea):
    ...
    def remove_nc_geometry(self, i_geometry_type: str) -> None:
        ...
        :rtype: None
        """
        return self.manufacturing_surface_machining_area.RemoveNCGeometry(
            i_geometry_type
        )
    ...
    def set_nc_geometry(self, i_geometry_type: str, i_nc_geometry: AnyObject) -> None:
        ...
        :rtype: None
        """
        return self.manufacturing_surface_machining_area.SetNCGeometry(
            i_geometry_type, i_nc_geometry.com_object
        )
