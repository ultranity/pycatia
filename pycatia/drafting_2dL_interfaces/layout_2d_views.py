...
class Layout2DViews(Collection[Layout2DView]):
    """
    .. note::
        :class: toggle
    ...
    def add_from_3d_plane(
        self, i_plane: tuple, i_view_type: int, i_x: float, i_y: float
    ) -> Layout2DView:
        """
        .. note::
            :class: toggle
        ...
        """
        return Layout2DView(
            self.layout2_d_views.AddFrom3DPlane(i_plane, i_view_type, i_x, i_y)
        )
    ...
    def add_related(
        self, i_reference_view: Layout2DView, i_side: int, i_x: float, i_y: float
    ) -> Layout2DView:
        """
        .. note::
            :class: toggle
        ...
        """
        return Layout2DView(
            self.layout2_d_views.AddRelated(
                i_reference_view.com_object, i_side, i_x, i_y
            )
        )
