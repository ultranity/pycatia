...
class PlugMapViewSettingAtt(SettingController):
    ...
    def addto_logical_data_attr_list(
        self, iparameter_name: str, i_refparam_name: str
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.plug_map_view_setting_att.AddtoLogicalDataAttrList(
            iparameter_name, i_refparam_name
        )

    def addto_termination_attr_list(
        self, iparameter_name: str, i_refparam_name: str
    ) -> None:
        """
        .. note::
        ...
        :rtype: None
        """
        return self.plug_map_view_setting_att.AddtoTerminationAttrList(
            iparameter_name, i_refparam_name
        )

    def get_logical_data_attr_list_info(
        ...
        :rtype: bool
        """
        return self.plug_map_view_setting_att.GetLogicalDataAttrListInfo(
            io_admin_level, io_locked
        )

    def get_termination_attr_list_info(
        self, io_admin_level: str, io_locked: str
    ) -> bool:
        """
        .. note::
        ...
        :rtype: bool
        """
        return self.plug_map_view_setting_att.GetTerminationAttrListInfo(
            io_admin_level, io_locked
        )
    ...
    def remove_from_logical_data_attr_list(self, iparameter_name: str) -> None:
        ...
        :rtype: None
        """
        return self.plug_map_view_setting_att.RemovefromLogicalDataAttrList(
            iparameter_name
        )
    ...
    def remove_from_termination_attr_list(self, iparameter_name: str) -> None:
        ...
        :rtype: None
        """
        return self.plug_map_view_setting_att.RemovefromTerminationAttrList(
            iparameter_name
        )
