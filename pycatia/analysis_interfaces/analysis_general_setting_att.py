...
class AnalysisGeneralSettingAtt(SettingController):
    ...
    def get_analysis_cache_mode_info(self, io_admin_level: str, io_locked: str) -> bool:
        ...
        :rtype: bool
        """
        return self.analysis_general_setting_att.GetAnalysisCacheModeInfo(
    ...
    def get_analysis_load_mode_info(self, io_admin_level: str, io_locked: str) -> bool:
        ...
        :rtype: bool
        """
        return self.analysis_general_setting_att.GetAnalysisLoadModeInfo(
            io_admin_level, io_locked
        )

    def get_analysis_naming_auto_info(
        ...
        :rtype: bool
        """
        return self.analysis_general_setting_att.GetAnalysisNamingAutoInfo(
            io_admin_level, io_locked
        )

    def get_default_analysis_flag_info(
        self, io_admin_level: str, io_locked: str
    ) -> bool:
        """
        .. note::
        ...
        :rtype: bool
        """
        return self.analysis_general_setting_att.GetDefaultAnalysisFlagInfo(
            io_admin_level, io_locked
        )

    def get_default_analysis_template_info(
        self, io_admin_level: str, io_locked: str
    ) -> bool:
        """
        .. note::
        ...
        :rtype: bool
        """
        return self.analysis_general_setting_att.GetDefaultAnalysisTemplateInfo(
            io_admin_level, io_locked
        )

    def get_view_analysis_parameter_info(
        self, io_admin_level: str, io_locked: str
    ) -> bool:
        """
        .. note::
        ...
        :rtype: bool
        """
        return self.analysis_general_setting_att.GetViewAnalysisParameterInfo(
            io_admin_level, io_locked
        )

    def get_view_analysis_relation_info(
        self, io_admin_level: str, io_locked: str
    ) -> bool:
        """
        .. note::
        ...
        :rtype: bool
        """
        return self.analysis_general_setting_att.GetViewAnalysisRelationInfo(
            io_admin_level, io_locked
        )
    ...
    def set_default_analysis_template_lock(self, i_locked: bool) -> None:
        ...
        :rtype: None
        """
        return self.analysis_general_setting_att.SetDefaultAnalysisTemplateLock(
            i_locked
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
