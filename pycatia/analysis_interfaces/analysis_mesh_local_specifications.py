...
from pycatia.analysis_interfaces.analysis_mesh_local_specification import (
...
class AnalysisMeshLocalSpecifications(Collection[AnalysisMeshLocalSpecification]):
    """
    .. note::
        :class: toggle
    ...
    def add(self, i_type: str) -> AnalysisMeshLocalSpecification:
        ...
        return AnalysisMeshLocalSpecification(
            self.analysis_mesh_local_specifications.Add(i_type)
        )
