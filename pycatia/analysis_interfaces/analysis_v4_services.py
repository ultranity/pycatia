...
class AnalysisV4Services(AnyObject):
    ...
    def print_assembled_sets_info(
        self, i_session_path: str, i_print_path: str, i_submesh: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.analysis_v4_services.PrintAssembledSetsInfo(
            i_session_path, i_print_path, i_submesh
        )

    def print_coupling_analysis_info(
        self, i_session_path: str, i_print_path: str, i_submesh: int
    ) -> None:
        """
        .. note::
        ...
        :rtype: None
        """
        return self.analysis_v4_services.PrintCouplingAnalysisInfo(
            i_session_path, i_print_path, i_submesh
        )
