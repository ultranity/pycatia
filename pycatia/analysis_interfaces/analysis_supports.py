...
class AnalysisSupports(Collection):  # TODO: check type & check is Collection
    """
    .. note::
        :class: toggle
    ...
    def item(
        self, i_index: int, o_positionning: AnyObject, o_pointed: AnyObject
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.analysis_supports.Item(
            i_index, o_positionning.com_object, o_pointed.com_object
        )
