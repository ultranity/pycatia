...
class AnalysisImport(AnyObject):
    ...
    def add_support(
        ...
        :rtype: None
        """
        return self.analysis_import.AddSupport(
            i_manager.com_object, i_product_support.com_object, i_support.com_object
        )
    ...
    def import_disp(
        ...
        :rtype: None
        """
        return self.analysis_import.ImportDisp(
            i_father_case.com_object,
            i_full_path,
            i_manager.com_object,
            i_axis.com_object,
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
    ...
    def import_force(
        ...
        :rtype: None
        """
        return self.analysis_import.ImportForce(
            i_father_case.com_object,
            i_full_path,
            i_manager.com_object,
            i_axis.com_object,
