...
class AnalysisPostProANRSettingAtt(SettingController):
    ...
    def get_dmu_player_deformation_info(
        ...
        :rtype: bool
        """
        return self.analysis_post_pro_anr_setting_att.GetDMUPlayerDeformationInfo(
    ...
    def get_dmu_player_mode_info(self, io_admin_level: str, io_locked: str) -> bool:
        ...
        :rtype: bool
        """
        return self.analysis_post_pro_anr_setting_att.GetDMUPlayerModeInfo(
            io_admin_level, io_locked
        )
    ...
    def set_dmu_player_deformation_lock(self, i_locked: bool) -> None:
        ...
        :rtype: None
        """
        return self.analysis_post_pro_anr_setting_att.SetDMUPlayerDeformationLock(
            i_locked
        )
