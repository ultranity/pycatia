...
class AnalysisPostManager(AnyObject):
    ...
    def build_report(
        self, i_folder: Folder, i_title: str, i_add_created_images: cat_variant
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.analysis_post_manager.BuildReport(
            i_folder.com_object, i_title, i_add_created_images
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def extract_html_report(self, i_folder: Folder, i_title: str) -> None:
        ...
        :rtype: None
        """
        return self.analysis_post_manager.ExtractHTMLReport(
            i_folder.com_object, i_title
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
