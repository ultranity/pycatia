...
class AnalysisMeshLocalSpecification(AnyObject):
    ...
    def add_support_from_publication(
        self, i_name: str, i_product: Product, i_support: Publication
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        return self.analysis_mesh_local_specification.AddSupportFromPublication(
            i_name, i_product.com_object, i_support.com_object
        )
    ...
    def add_support_from_reference(
        self, i_name: str, i_product: Product, i_support: Reference
    ) -> None:
        """
        .. note::
            :class: toggle
