...
class RobotMotion(Activity):
    ...
    def get_auxillary_axis_home(
        self, i_device: AnyObject, i_auxillary_axis: str, o_home_name: str
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.robot_motion.GetAuxillaryAxisHome(
            i_device.com_object, i_auxillary_axis, o_home_name
        )

    def get_auxillary_axis_values(
        self, i_device: AnyObject, i_auxillary_axis: str, o_auxillary_axis_values: tuple
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.robot_motion.GetAuxillaryAxisValues(
            i_device.com_object, i_auxillary_axis, o_auxillary_axis_values
        )
    ...
    def set_auxillary_axis_home(
        self, i_device: AnyObject, i_auxillary_axis: str, i_home_name: str
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.robot_motion.SetAuxillaryAxisHome(
            i_device.com_object, i_auxillary_axis, i_home_name
        )

    def set_auxillary_axis_values(
        self, i_device: AnyObject, i_auxillary_axis: str, i_auxillary_axis_values: tuple
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.robot_motion.SetAuxillaryAxisValues(
            i_device.com_object, i_auxillary_axis, i_auxillary_axis_values
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
