...
class TagGroupFactory(AnyObject):
    ...
    def copy_tag_group(self, i_tag_group: TagGroup, io_tag_group: TagGroup) -> TagGroup:
        ...
        """
        return TagGroup(
            self.tag_group_factory.CopyTagGroup(
                i_tag_group.com_object, io_tag_group.com_object
            )
        )
    ...
    def create_tag_group_in_doc(
        self, i_tag_group_name: str, o_tag_group: TagGroup
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.tag_group_factory.CreateTagGroupInDoc(
            i_tag_group_name, o_tag_group.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def reparent_tag_group(
        self, i_tag_group: TagGroup, io_product: Product, i_modify_reference: bool
    ) -> TagGroup:
        """
        .. note::
            :class: toggle
        ...
        return TagGroup(
            self.tag_group_factory.ReparentTagGroup(
                i_tag_group.com_object, io_product.com_object, i_modify_reference
            )
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
