...
class ParameterProfiles(AnyObject):
    ...
    def get_attribute_value(
        self, i_attribute_name: str, o_encapsulated_attribute_value: str
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.parameter_profiles.GetAttributeValue(
            i_attribute_name, o_encapsulated_attribute_value
        )
    ...
    def set_attribute_value(
        self, i_attribute_name: str, i_encapsulated_attribute_value: str
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.parameter_profiles.SetAttributeValue(
            i_attribute_name, i_encapsulated_attribute_value
        )
