...
from pycatia.dnb_robot_interfaces.generic_obj_frame_profile import (
...
class RobControllerFactory(AnyObject):
    ...
    def create_generic_accuracy_profile(
        self, o_accuracy_profile: GenericAccuracyProfile
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.rob_controller_factory.CreateGenericAccuracyProfile(
            o_accuracy_profile.com_object
        )
    ...
    def create_generic_motion_profile(
        self, o_motion_profile: GenericMotionProfile
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.rob_controller_factory.CreateGenericMotionProfile(
            o_motion_profile.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def create_generic_obj_frame_profile(
        self, o_obj_frame_profile: GenericObjFrameProfile
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.rob_controller_factory.CreateGenericObjFrameProfile(
            o_obj_frame_profile.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def create_generic_tool_profile(self, o_tool_profile: GenericToolProfile) -> None:
        ...
        :rtype: None
        """
        return self.rob_controller_factory.CreateGenericToolProfile(
            o_tool_profile.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
