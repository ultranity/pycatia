...
class ParameterProfilesFactory(AnyObject):
    ...
    def create_profile_instance(
        ...
        return self.parameter_profiles_factory.CreateProfileInstance(
            i_profile_type, i_instance_name, o_app_parameter_profile.com_object
        )
    ...
    def delete_profile_instance(self, io_parameter_profile: ParameterProfiles) -> None:
        ...
        :rtype: None
        """
        return self.parameter_profiles_factory.DeleteProfileInstance(
            io_parameter_profile.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def get_all_profile_instances(
        self, o_all_instances_on_product: tuple
    ) -> ParameterProfiles:
        """
        .. note::
            :class: toggle
        ...
        return ParameterProfiles(
            self.parameter_profiles_factory.GetAllProfileInstances(
                o_all_instances_on_product
            )
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
    ...
    def get_profile_instance(
        self, i_instance_name: str, o_profile_instance: ParameterProfiles
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.parameter_profiles_factory.GetProfileInstance(
            i_instance_name, o_profile_instance.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def get_profile_instances(
        self, i_profile_type: str, o_profiles: tuple
    ) -> ParameterProfiles:
        """
        .. note::
            :class: toggle
        ...
        """
        return ParameterProfiles(
            self.parameter_profiles_factory.GetProfileInstances(
                i_profile_type, o_profiles
            )
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
