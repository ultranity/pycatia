...
class ShapeFactory(Factory):
    ...
    def add_new_affinity2(
        ...
        return AnyObject.new(
            self.shape_factory.AddNewAffinity2(x_ratio, y_ratio, z_ratio)
        )
    ...
    def add_new_blend(self) -> AnyObject:
        ...
        :rtype: AnyObject
        """
        return AnyObject.new(self.shape_factory.AddNewBlend())
    ...
    def add_new_loft(self) -> AnyObject:
        ...
        :rtype: AnyObject
        """
        return AnyObject.new(self.shape_factory.AddNewLoft())
    ...
    def add_new_removed_blend(self) -> AnyObject:
        ...
        :rtype: AnyObject
        """
        return AnyObject.new(self.shape_factory.AddNewRemovedBlend())
    ...
    def add_new_removed_loft(self) -> AnyObject:
        ...
        :rtype: AnyObject
        """
        return AnyObject.new(self.shape_factory.AddNewRemovedLoft())
    ...
    def add_new_rotate2(self, i_axis: Reference, i_angle: float) -> AnyObject:
        ...
        return AnyObject.new(
            self.shape_factory.AddNewRotate2(i_axis.com_object, i_angle)
        )
