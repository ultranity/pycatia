...
class CatalogDocument(Document):
    ...
    def create_catalog_from_library(
        self,
        i_library_path: str,
        i_project_path: str,
        i_catalog_path: str,
    ...
    def create_catalog_from_csv(
        self, i_init_data: str, i_new_catalog: str
    ) -> "CatalogDocument":
        """
        .. note::
            :class: toggle
    ...
    def create_chapter_from_design_table(
        self, i_chapter_name: str, i_document_containing_dt: str
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.catalog_document.CreateChapterFromDesignTable(
            i_chapter_name, i_document_containing_dt
        )
