...
class ColourStdObjectSettingAtt(SettingController):
    ...
    def get_plate_colour(
        ...
        :rtype: None
        """
        return self.colour_std_object_setting_att.GetPlateColor(
    ...
    def get_plate_colour_info(self, io_admin_level: str, io_locked: str) -> bool:
        ...
        :rtype: bool
        """
        return self.colour_std_object_setting_att.GetPlateColorInfo(
            io_admin_level, io_locked
        )

    def get_shape_colour(
        self, o_shape_colour_r: int, o_shape_colour_g: int, o_shape_colour_b: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.colour_std_object_setting_att.GetShapeColor(
            o_shape_colour_r, o_shape_colour_g, o_shape_colour_b
        )
    ...
    def get_shape_colour_info(self, io_admin_level: str, io_locked: str) -> bool:
        ...
        :rtype: bool
        """
        return self.colour_std_object_setting_att.GetShapeColorInfo(
            io_admin_level, io_locked
        )
    ...
    def set_plate_colour(
        ...
        :rtype: None
        """
        return self.colour_std_object_setting_att.SetPlateColor(
    ...
    def set_shape_colour(
        self, i_shape_colour_r: int, i_shape_colour_g: int, i_shape_colour_b: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.colour_std_object_setting_att.SetShapeColor(
            i_shape_colour_r, i_shape_colour_g, i_shape_colour_b
        )
