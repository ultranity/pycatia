...
class StrObjectFactory(AnyObject):
    ...
    def add_def_ext_from_coordinates(
        self, i_coord: tuple, i_offset: float
    ) -> AnyObject:
        """
        .. note::
            :class: toggle
        ...
        return AnyObject.new(
            self.str_object_factory.AddDefExtFromCoordinates(i_coord, i_offset)
        )

    def add_def_ext_from_reference(
        self, i_reference: Reference, i_offset: float
    ) -> AnyObject:
        """
        .. note::
            :class: toggle
        ...
        """
        return AnyObject.new(
            self.str_object_factory.AddDefExtFromReference(
                i_reference.com_object, i_offset
            )
        )

    def add_def_ext_on_member(
        self, i_member: StrMember, i_side: int, i_distance: float, i_offset: float
    ) -> AnyObject:
        """
        .. note::
            :class: toggle
        ...
        """
        return AnyObject.new(
            self.str_object_factory.AddDefExtOnMember(
                i_member.com_object, i_side, i_distance, i_offset
            )
        )
    ...
    def add_plate_on_surface(
        ...
        return StrPlate(
            self.str_object_factory.AddPlateOnSurface(
                i_thickness, i_orientation, i_surface.com_object, i_offset, i_type
            )
        )
    ...
    def add_section_from_catalog(
        ...
        return StrSection(
            self.str_object_factory.AddSectionFromCatalog(
                i_part.com_object, i_catalog_name, i_family_name, i_section_name
            )
        )
