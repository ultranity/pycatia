...
class ColourEssObjectSettingAtt(SettingController):
    ...
    def get_member_colour(
        self, o_member_colour_r: int, o_member_colour_g: int, o_member_colour_b: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.colour_ess_object_setting_att.GetMemberColor(
            o_member_colour_r, o_member_colour_g, o_member_colour_b
        )
    ...
    def get_member_colour_info(self, io_admin_level: str, io_locked: str) -> bool:
        ...
        :rtype: bool
        """
        return self.colour_ess_object_setting_att.GetMemberColorInfo(
            io_admin_level, io_locked
        )

    def get_plate_colour(
        self, o_plate_colour_r: int, o_plate_colour_g: int, o_plate_colour_b: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.colour_ess_object_setting_att.GetPlateColor(
            o_plate_colour_r, o_plate_colour_g, o_plate_colour_b
        )
    ...
    def get_plate_colour_info(self, io_admin_level: str, io_locked: str) -> bool:
        ...
        :rtype: bool
        """
        return self.colour_ess_object_setting_att.GetPlateColorInfo(
            io_admin_level, io_locked
        )

    def set_member_colour(
        self, i_member_colour_r: int, i_member_colour_g: int, i_member_colour_b: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.colour_ess_object_setting_att.SetMemberColor(
            i_member_colour_r, i_member_colour_g, i_member_colour_b
        )
    ...
    def set_plate_colour(
        self, i_plate_colour_r: int, i_plate_colour_g: int, i_plate_colour_b: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.colour_ess_object_setting_att.SetPlateColor(
            i_plate_colour_r, i_plate_colour_g, i_plate_colour_b
        )
