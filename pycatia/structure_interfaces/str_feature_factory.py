...
class StrFeatureFactory(AnyObject):
    ...
    def add_cutout_with_after_forming_mode(
        self, i_contour: Reference, i_direction: Reference
    ) -> StrCutoutFeature:
        """
        .. note::
            :class: toggle
        ...
        return StrCutoutFeature(
            self.str_feature_factory.AddCutoutWithAfterFormingMode(
                i_contour.com_object, i_direction.com_object
            )
        )

    def add_cutout_with_before_forming_mode(
        self, i_contour: Reference, i_surface: Reference
    ) -> StrCutoutFeature:
        """
        .. note::
            :class: toggle
        ...
        """
        return StrCutoutFeature(
            self.str_feature_factory.AddCutoutWithBeforeFormingMode(
                i_contour.com_object, i_surface.com_object
            )
        )

    def add_nibbling(
        self, i_list_of_limiting_elements: tuple, i_nibbling_type: str
    ) -> StrNibblingFeature:
        """
        .. note::
            :class: toggle
        ...
        return StrNibblingFeature(
            self.str_feature_factory.AddNibbling(
                i_list_of_limiting_elements, i_nibbling_type
            )
        )
