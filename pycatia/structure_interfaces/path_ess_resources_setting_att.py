...
class PathEssResourcesSettingAtt(SettingController):
    ...
    def get_resolved_sections_path_info(
        ...
        :rtype: bool
        """
        return self.path_ess_resources_setting_att.GetResolvedSectionsPathInfo(
            io_admin_level, io_locked
        )

    def get_sections_catalog_path_info(
        self, io_admin_level: str, io_locked: str
    ) -> bool:
        """
        .. note::
        ...
        :rtype: bool
        """
        return self.path_ess_resources_setting_att.GetSectionsCatalogPathInfo(
            io_admin_level, io_locked
        )
    ...
    def get_thickness_list_path_info(self, io_admin_level: str, io_locked: str) -> bool:
        ...
        :rtype: bool
        """
        return self.path_ess_resources_setting_att.GetThicknessListPathInfo(
            io_admin_level, io_locked
        )
