...
class SchCntrLocation(AnyObject):
    ...
    def get_align_vector(
        self, i_grr: SchGRR, o_db2_align_vector: SchListOfDoubles
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_cntr_location.GetAlignVector(
            i_grr.com_object, o_db2_align_vector.com_object
        )
    ...
    def get_position(self, i_grr: SchGRR, o_db2_position: SchListOfDoubles) -> None:
        ...
        :rtype: None
        """
        return self.sch_cntr_location.GetPosition(
            i_grr.com_object, o_db2_position.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def get_relative_position(self, o_db2_relative_position: SchListOfDoubles) -> None:
        ...
        :rtype: None
        """
        return self.sch_cntr_location.GetRelativePosition(
            o_db2_relative_position.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def set_align_vector(self, i_grr: SchGRR, i_db2_align_vector: tuple) -> tuple:
        ...
        :rtype: tuple
        """
        return self.sch_cntr_location.SetAlignVector(
            i_grr.com_object, i_db2_align_vector
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
