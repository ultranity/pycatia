...
class SchAppCompatible(AnyObject):
    ...
    def app_is_target_ok_for_insert(
        ...
        return self.sch_app_compatible.AppIsTargetOKForInsert(
            i_l_comp_source_cntrs.com_object, o_l_source_cntrs.com_object, o_b_yes
        )
    ...
    def app_is_target_ok_for_place(
        ...
        return self.sch_app_compatible.AppIsTargetOKForPlace(
            i_l_comp_source_cntrs.com_object, o_l_target_cntrs.com_object, o_b_yes
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def app_is_target_ok_for_route(
        self, i_route_cntr_class_type: str, o_lok_cntrs: SchListOfObjects, o_b_yes: bool
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        return self.sch_app_compatible.AppIsTargetOKForRoute(
            i_route_cntr_class_type, o_lok_cntrs.com_object, o_b_yes
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
