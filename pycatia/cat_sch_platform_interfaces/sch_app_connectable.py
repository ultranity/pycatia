...
class SchAppConnectable(AnyObject):
    ...
    def app_add_connector(
        self, i_class_type: str, o_new_app_cntr: SchAppConnector
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_app_connectable.AppAddConnector(
            i_class_type, o_new_app_cntr.com_object
        )
    ...
    def app_list_connectors(
        self, i_l_cntr_class_filter: SchListOfBSTRs
    ) -> SchListOfObjects:
        """
        .. note::
            :class: toggle
        ...
        return SchListOfObjects(
            self.sch_app_connectable.AppListConnectors(i_l_cntr_class_filter.com_object)
        )
