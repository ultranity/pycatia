...
from pycatia.cat_sch_platform_interfaces.sch_app_multi_image_master import (
...
class SchAppMultiImage(AnyObject):
    ...
    def app_get_master_document(
        self, o_document: Document, o_document_name: str, o_symbolic_link_name: str
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        return self.sch_app_multi_image.AppGetMasterDocument(
            o_document.com_object, o_document_name, o_symbolic_link_name
        )
    ...
    def app_update(
        self, i_master_image: SchAppMultiImageMaster, o_image: "SchAppMultiImage"
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_app_multi_image.AppUpdate(
            i_master_image.com_object, o_image.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
