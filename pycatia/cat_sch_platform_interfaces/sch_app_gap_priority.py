...
class SchAppGapPriority(AnyObject):
    ...
    def app_choose_gap_priority(
        self, i_the_other_route: SchRoute, o_priority: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_app_gap_priority.AppChooseGapPriority(
            i_the_other_route.com_object, o_priority
        )
