...
class SchRouteAlternateGraphic(AnyObject):
    ...
    def add_alternate_graphic(
        self, i_initial_xy_position: tuple, o_added_grr: SchGRR
    ) -> tuple:
        """
        .. note::
            :class: toggle
        ...
        :rtype: tuple
        """
        return self.sch_route_alternate_graphic.AddAlternateGraphic(
            i_initial_xy_position, o_added_grr.com_object
        )
    ...
    def list_alternate_graphics(self) -> SchListOfObjects:
        ...
        return SchListOfObjects(
            self.sch_route_alternate_graphic.ListAlternateGraphics()
        )
    ...
    def remove_all_alternate_graphics_of_style(self, i_style: int) -> None:
        ...
        :rtype: None
        """
        return self.sch_route_alternate_graphic.RemoveAllAlternateGraphicsOfStyle(
            i_style
        )
    ...
    def remove_alternate_graphic(self, i_grr_to_be_removed: SchGRR) -> None:
        ...
        :rtype: None
        """
        return self.sch_route_alternate_graphic.RemoveAlternateGraphic(
            i_grr_to_be_removed.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
