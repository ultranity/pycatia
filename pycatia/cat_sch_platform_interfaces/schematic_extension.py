...
class SchematicExtension(AnyObject):
    ...
    def add_extension(
        ...
        return self.schematic_extension.AddExtension(
            i_app_obj_to_be_extended.com_object, i_extension_type, i_lgrr.com_object
        )
    ...
    def remove_extension(
        self, i_app_extended_obj: AnyObject, i_extension_type: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.schematic_extension.RemoveExtension(
            i_app_extended_obj.com_object, i_extension_type
        )
