...
class SchComponent(AnyObject):
    ...
    def create_component_inst(
        self, i_grr: SchGRRComp, i_db6_axis: tuple, o_new_component: "SchComponent"
    ) -> tuple:
        """
        .. note::
            :class: toggle
        ...
        :rtype: tuple
        """
        return self.sch_component.CreateComponentInst(
            i_grr.com_object, i_db6_axis, o_new_component.com_object
        )
    ...
    def create_local_reference(
        ...
        """
        return SchComponent(
            self.sch_component.CreateLocalReference(
    ...
    def insert_into_route_with_info(
        ...
        return self.sch_component.InsertIntoRouteWithInfo(
            i_insert_info.com_object, o_new_component.com_object, o_new_route.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def place_in_space(
        ...
        :rtype: tuple
        """
        return self.sch_component.PlaceInSpace(
            i_grr.com_object, i_db6_axis, o_new_component.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
    ...
    def place_on_component_with_info(self, i_place_info: AnyObject) -> "SchComponent":
        ...
        """
        return SchComponent(
            self.sch_component.PlaceOnComponentWithInfo(i_place_info.com_object)
        )
    ...
    def query_connect_ability(self, i_grr: SchGRRComp) -> AnyObject:
        ...
        :rtype: AnyObject
        """
        return AnyObject.new(self.sch_component.QueryConnectAbility(i_grr.com_object))
