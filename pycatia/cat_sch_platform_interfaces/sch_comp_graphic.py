...
class SchCompGraphic(AnyObject):
    ...
    def activate(
        self, i_grr_name: str, i_db2_where_at: tuple, o_grr: SchGRRComp
    ) -> tuple:
        """
        .. note::
            :class: toggle
        ...
        :rtype: tuple
        """
        return self.sch_comp_graphic.Activate(
            i_grr_name, i_db2_where_at, o_grr.com_object
        )
    ...
    def remove_graphical_representation(self, i_grr_to_remove: SchGRRComp) -> None:
        ...
        :rtype: None
        """
        return self.sch_comp_graphic.RemoveGraphicalRepresentation(
            i_grr_to_remove.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def switch(self, i_grr: SchGRRComp, i_grr_name: str, o_grr: SchGRRComp) -> None:
        ...
        :rtype: None
        """
        return self.sch_comp_graphic.Switch(
            i_grr.com_object, i_grr_name, o_grr.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
