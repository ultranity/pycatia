...
class SchCompatible(AnyObject):
    ...
    def is_target_ok_for_insert(
        self, i_comp_info: AnyObject, o_insert_compat_info: AnyObject, o_b_yes: bool
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_compatible.IsTargetOKForInsert(
            i_comp_info.com_object, o_insert_compat_info.com_object, o_b_yes
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
