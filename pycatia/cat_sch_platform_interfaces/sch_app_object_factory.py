...
class SchAppObjectFactory(AnyObject):
    ...
    def app_create_comp_ref(
        self, i_app_comp_class_type: str, o_app_comp: AnyObject
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_app_object_factory.AppCreateCompRef(
            i_app_comp_class_type, o_app_comp.com_object
        )

    def app_create_connection(
        self, i_app_cntn_class_type: str, o_app_connection: AnyObject
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_app_object_factory.AppCreateConnection(
            i_app_cntn_class_type, o_app_connection.com_object
        )

    def app_create_group(
        self, i_app_group_class_type: str, o_app_group: AnyObject
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_app_object_factory.AppCreateGroup(
            i_app_group_class_type, o_app_group.com_object
        )

    def app_create_route(
        self, i_app_route_class_type: str, o_app_route: AnyObject, i_log_line_id: str
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_app_object_factory.AppCreateRoute(
            i_app_route_class_type, o_app_route.com_object, i_log_line_id
        )

    def app_create_route_from_ref(
        self, i_route_reference: SchAppRoute, o_app_route: AnyObject, i_log_line_id: str
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        return self.sch_app_object_factory.AppCreateRouteFromRef(
            i_route_reference.com_object, o_app_route.com_object, i_log_line_id
        )
    ...
    def app_create_zone(
        self, i_app_zone_class_type: str, o_app_zone: AnyObject
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_app_object_factory.AppCreateZone(
            i_app_zone_class_type, o_app_zone.com_object
        )
