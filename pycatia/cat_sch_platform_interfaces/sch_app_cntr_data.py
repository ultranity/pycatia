...
class SchAppCntrData(AnyObject):
    ...
    def app_get_application_data(
        self, i_l_app_data: SchListOfBSTRs, i_l_app_nls_data: SchListOfBSTRs
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_app_cntr_data.AppGetApplicationData(
            i_l_app_data.com_object, i_l_app_nls_data.com_object
        )
    ...
    def app_list_potential_data(
        ...
        :rtype: None
        """
        return self.sch_app_cntr_data.AppListPotentialData(
            i_l_app_data.com_object, i_l_app_nls_data.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
