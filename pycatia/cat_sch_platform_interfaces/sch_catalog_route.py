...
class SchCatalogRoute(AnyObject):
    ...
    def query_drop_ability(
        self, o_b_yes: bool, o_route_ref: SchRoute, o_pointed_to_grr: SchGRR
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_catalog_route.QueryDropAbility(
            o_b_yes, o_route_ref.com_object, o_pointed_to_grr.com_object
        )
