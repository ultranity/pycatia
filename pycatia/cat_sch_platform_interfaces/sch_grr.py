...
class SchGRR(AnyObject):
    ...
    def get_sch_cntr_owners(
        self, o_cntr_owner: SchAppConnector, o_grr_owner: "SchGRR"
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_grr.GetSchCntrOwners(
            o_cntr_owner.com_object, o_grr_owner.com_object
        )
