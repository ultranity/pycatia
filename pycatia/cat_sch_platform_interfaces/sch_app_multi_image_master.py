...
class SchAppMultiImageMaster(AnyObject):
    ...
    def app_is_ok_to_create_image(
        ...
        return self.sch_app_multi_image_master.AppIsOKToCreateImage(
            i_image_doc.com_object, o_b_yes, o_nls_file_name, o_nls_file_key_to_message
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def app_list_images(
        self, i_l_filter: SchListOfBSTRs, o_l_images: SchListOfObjects
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_app_multi_image_master.AppListImages(
            i_l_filter.com_object, o_l_images.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
