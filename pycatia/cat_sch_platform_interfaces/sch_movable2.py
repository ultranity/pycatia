...
class SchMovable2(AnyObject):
    ...
    def rotate_at_point(
        self, i_db1_rotation_angle_in_radian: float, i_db2_center_point: tuple
    ) -> tuple:
        """
        .. note::
            :class: toggle
        ...
        :rtype: tuple
        """
        return self.sch_movable2.RotateAtPoint(
            i_db1_rotation_angle_in_radian, i_db2_center_point
        )
