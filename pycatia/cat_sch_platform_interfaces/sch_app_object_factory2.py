...
class SchAppObjectFactory2(AnyObject):
    ...
    def app_create_comp_ref(
        self, i_app_comp_class_type: str, i_doc: Document, o_app_comp: AnyObject
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        return self.sch_app_object_factory2.AppCreateCompRef(
            i_app_comp_class_type, i_doc.com_object, o_app_comp.com_object
        )
    ...
    def app_create_connection(
        self, i_app_cntn_class_type: str, i_doc: Document, o_app_connection: AnyObject
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        return self.sch_app_object_factory2.AppCreateConnection(
            i_app_cntn_class_type, i_doc.com_object, o_app_connection.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def app_create_group(
        self, i_app_group_class_type: str, i_doc: Document, o_app_group: AnyObject
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        return self.sch_app_object_factory2.AppCreateGroup(
            i_app_group_class_type, i_doc.com_object, o_app_group.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def app_create_route_with_info(
        self, i_app_route_class_type: str, i_app_info: AnyObject, o_app_route: AnyObject
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        return self.sch_app_object_factory2.AppCreateRouteWithInfo(
            i_app_route_class_type, i_app_info.com_object, o_app_route.com_object
        )

    def app_create_zone(
        self, i_app_zone_class_type: str, i_doc: Document, o_app_zone: AnyObject
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        return self.sch_app_object_factory2.AppCreateZone(
            i_app_zone_class_type, i_doc.com_object, o_app_zone.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
