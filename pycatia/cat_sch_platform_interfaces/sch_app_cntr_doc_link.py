...
class SchAppCntrDocLink(AnyObject):
    ...
    def app_get_link(
        ...
        return self.sch_app_cntr_doc_link.AppGetLink(
            o_l_cntrs.com_object, o_l_document_names.com_object, o_publication_name
        )
    ...
    def app_is_linkable(self, i_sch_connector: SchAppConnector, o_b_yes: bool) -> None:
        ...
        :rtype: None
        """
        return self.sch_app_cntr_doc_link.AppIsLinkable(
            i_sch_connector.com_object, o_b_yes
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def app_open_linked_doc(
        self, i_document_name: str, i_document_uuid: str, o_document: Document
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_app_cntr_doc_link.AppOpenLinkedDoc(
            i_document_name, i_document_uuid, o_document.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
