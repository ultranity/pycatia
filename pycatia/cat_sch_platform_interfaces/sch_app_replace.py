...
class SchAppReplace(AnyObject):
    ...
    def app_ok_to_replace(
        self, i_sch_object_to_be_replaced_by_this: AnyObject, o_b_yes: bool
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_app_replace.AppOKToReplace(
            i_sch_object_to_be_replaced_by_this.com_object, o_b_yes
        )
    ...
    def app_post_replace_process(
        self, i_sch_object_to_be_replaced_by_this: AnyObject
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_app_replace.AppPostReplaceProcess(
            i_sch_object_to_be_replaced_by_this.com_object
        )
