...
class SchSession(AnyObject):
    ...
    def create_document(
        self, i_doc_type: str, i_b_interactive: bool, o_new_doc: Document
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_session.CreateDocument(
            i_doc_type, i_b_interactive, o_new_doc.com_object
        )
    ...
    def get_sch_ext_container(self, i_doc: Document) -> AnyObject:
        ...
        :rtype: AnyObject
        """
        return AnyObject.new(self.sch_session.GetSchExtContainer(i_doc.com_object))
