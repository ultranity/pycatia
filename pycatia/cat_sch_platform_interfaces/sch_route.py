...
class SchRoute(AnyObject):
    ...
    def add_points(
        ...
        :rtype: tuple
        """
        return self.sch_route.AddPoints(
            i_grr.com_object, i_l_db2_pt_path_to_add, i_after_which_pt_num
        )
    ...
    def break_(
        ...
        :rtype: tuple
        """
        return self.sch_route.Break(
            i_grr.com_object, i_db2_pt1, i_db2_pt2, o_new_sch_route.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def get_extremity_cntrs(
        ...
        :rtype: None
        """
        return self.sch_route.GetExtremityCntrs(
            i_grr.com_object, o_route_cntr1.com_object, o_route_cntr2.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def ok_to_branch(
        self, i_grr: SchGRRRoute, i_branch_class_type: str, o_b_yes: bool
    ) -> None:
        """
        .. note::
            :class: toggle
    ...
    def remove_points(
        self, i_grr: SchGRRRoute, i_num_of_pts_to_remove: int, i_after_which_pt_num: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_route.RemovePoints(
            i_grr.com_object, i_num_of_pts_to_remove, i_after_which_pt_num
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def reshape_extremity(
        self, i_grr: SchGRRRoute, i_route_cntr: SchAppConnector, i_db2_delta_xy: tuple
    ) -> tuple:
        """
        .. note::
            :class: toggle
        ...
        :rtype: tuple
        """
        return self.sch_route.ReshapeExtremity(
            i_grr.com_object, i_route_cntr.com_object, i_db2_delta_xy
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
