...
class SchGRRRoute(AnyObject):
    ...
    def add_points(
        self, i_l_db2_pt_path_to_add: tuple, i_after_which_pt_num: int
    ) -> tuple:
        """
        .. note::
            :class: toggle
        ...
        :rtype: tuple
        """
        return self.sch_grr_route.AddPoints(
            i_l_db2_pt_path_to_add, i_after_which_pt_num
        )
    ...
    def break_(
        self, i_db2_pt1: tuple, i_db2_pt2: tuple, o_new_grr_route: "SchGRRRoute"
    ) -> tuple:
        """
        .. note::
            :class: toggle
        ...
        :rtype: tuple
        """
        return self.sch_grr_route.Break(
            i_db2_pt1, i_db2_pt2, o_new_grr_route.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def concatenate(
        self, i_which_end1: int, i_grr_route2: "SchGRRRoute", i_which_end2: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_grr_route.Concatenate(
            i_which_end1, i_grr_route2.com_object, i_which_end2
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def concatenate_keep_grr2(
        ...
        :rtype: None
        """
        return self.sch_grr_route.ConcatenateKeepGRR2(
            i_which_end1, i_grr_route2.com_object, i_which_end2
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
    ...
    def create_route_symbol(
        ...
        return self.sch_grr_route.CreateRouteSymbol(
            i_seg_num, i_seg_parm, i_grr_symbol.com_object, o_route_symbol.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def remove_points(
        self, i_num_of_pts_to_remove: int, i_after_which_pt_num: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sch_grr_route.RemovePoints(
            i_num_of_pts_to_remove, i_after_which_pt_num
        )
    ...
    def set_path2(
        self, i_l_db2_pt_path: tuple, i_compress: int, i_unset_gaps: int
    ) -> tuple:
        """
        .. note::
            :class: toggle
    ...
    def set_path3(
        ...
        :rtype: tuple
        """
        return self.sch_grr_route.SetPath3(
            i_l_db2_pt_path, i_compress, i_unset_gaps, i_route_update_symbols
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
