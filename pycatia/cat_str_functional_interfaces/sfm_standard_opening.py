...
class SFMStandardOpening(AnyObject):
    ...
    def get_contour(
        self, o_contour_name: str, o_list_contour_params: SFMStandardContourParameters
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sfm_standard_opening.GetContour(
            o_contour_name, o_list_contour_params.com_object
        )
    ...
    def get_positioning_strategy(
        ...
        :rtype: None
        """
        return self.sfm_standard_opening.GetPositioningStrategy(
            o_pos_strategy_name, o_list_pos_params.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def set_contour(
        self, i_contour_name: str, i_list_contour_params: SFMStandardContourParameters
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.sfm_standard_opening.SetContour(
            i_contour_name, i_list_contour_params.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def set_positioning_strategy(
        ...
        :rtype: None
        """
        return self.sfm_standard_opening.SetPositioningStrategy(
            i_pos_strategy_name, i_list_pos_params.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
