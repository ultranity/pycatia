...
from pycatia.cat_str_functional_interfaces.sfm_standard_opening import (
    SFMStandardOpening,
)
from pycatia.cat_str_functional_interfaces.sfm_standard_pos_strategy_parameters import (
...
class SFMFunctionFactory(Factory):
    ...
    def get_opening_mgr(self, i_prt_part: Part, i_mgr_name: str) -> AnyObject:
        ...
        :rtype: AnyObject
        """
        return self.sfm_function_factory.GetOpeningMgr(
            i_prt_part.com_object, i_mgr_name
        )
