...
class SFMPositioningStrategyManager(AnyObject):
    ...
    def get_available_positioning_strategies(
        self, o_list_strategy_names: tuple
    ) -> cat_variant:
        """
        .. note::
            :class: toggle
        ...
        :rtype: cat_variant
        """
        return self.sfm_positioning_strategy_manager.GetAvailablePositioningStrategies(
            o_list_strategy_names
        )
    ...
    def get_positioning_strategy_params(
        self, i_pos_strategy_name: str
    ) -> SFMStandardPosStrategyParameters:
        """
        .. note::
            :class: toggle
