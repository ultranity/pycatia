...
class SFMManager(AnyObject):
    ...
    def get_reference_plane(
        self, i_plane_system_index: cat_variant, i_plane_index: cat_variant
    ) -> Reference:
        """
        .. note::
            :class: toggle
        ...
        """
        return Reference(
            self.sfm_manager.GetReferencePlane(i_plane_system_index, i_plane_index)
        )
