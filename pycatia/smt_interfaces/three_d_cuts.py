...
class ThreeDCuts(Collection):  # TODO: check type & check is Collection
    """
    .. note::
        :class: toggle
    ...
    def compute_3d_cut(
        self, group_of_selected_products: Group, three_d_cut_document: Document
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.three_d_cuts.Compute3DCut(
            group_of_selected_products.com_object, three_d_cut_document.com_object
        )
