...
class DnbAttachmentFactory(AnyObject):
    ...
    def attach(
        self, i_parent: AnyObject, i_child: AnyObject, o_attachment: AnyObject
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.dnb_attachment_factory.Attach(
            i_parent.com_object, i_child.com_object, o_attachment.com_object
        )
