...
class MachiningProcess(ManufacturingActivity):
    ...
    def insert_activity(
        self, i_activity_type: str, i_referenced_activity: ManufacturingActivity
    ) -> ManufacturingActivity:
        """
        .. note::
            :class: toggle
        ...
        return ManufacturingActivity(
            self.machining_process.InsertActivity(
                i_activity_type, i_referenced_activity.com_object
            )
        )
    ...
    def instantiate_in_product_context(
        self, i_feature: AnyObject, i_product: Product
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.machining_process.InstantiateInProductContext(
            i_feature.com_object, i_product.com_object
        )
