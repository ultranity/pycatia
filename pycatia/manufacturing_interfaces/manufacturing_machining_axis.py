...
class ManufacturingMachiningAxis(ManufacturingFeature):
    ...
    def set_origin_point(self, i_point: AnyObject, i_product: AnyObject) -> None:
        ...
        :rtype: None
        """
        return self.manufacturing_machining_axis.SetOriginPoint(
            i_point.com_object, i_product.com_object
        )
    ...
    def set_part_axis_system(self, i_pas: AnyObject, i_product: AnyObject) -> None:
        ...
        :rtype: None
        """
        return self.manufacturing_machining_axis.SetPartAxisSystem(
            i_pas.com_object, i_product.com_object
        )
