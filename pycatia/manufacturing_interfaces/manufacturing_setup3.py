...
class ManufacturingSetup3(ManufacturingActivity):
    ...
    def add_fixture(
        self, i_geometry: AnyObject, i_product: AnyObject, i_position: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.manufacturing_setup3.AddFixture(
            i_geometry.com_object, i_product.com_object, i_position
        )
