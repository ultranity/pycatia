...
class ManufacturingCopyTransformation(ManufacturingActivity):
    ...
    def add_operation(self, i_manufacturing_activity: ManufacturingActivity) -> None:
        ...
        :rtype: None
        """
        return self.manufacturing_copy_transformation.AddOperation(
            i_manufacturing_activity.com_object
        )
    ...
    def get_trajectory_end_point_coord(self, o_end_point: tuple) -> None:
        ...
        :rtype: None
        """
        return self.manufacturing_copy_transformation.GetTrajectoryEndPointCoord(
            o_end_point
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
    ...
    def get_trajectory_start_point_coord(self, o_start_point: tuple) -> None:
        ...
        :rtype: None
        """
        return self.manufacturing_copy_transformation.GetTrajectoryStartPointCoord(
            o_start_point
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
    ...
    def set_copy_transformation(
        self, i_number_of_copies: int, i_ordering: str, i_transformation_type: str
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        return self.manufacturing_copy_transformation.SetCopyTransformation(
            i_number_of_copies, i_ordering, i_transformation_type
        )
