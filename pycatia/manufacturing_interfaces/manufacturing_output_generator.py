...
from pycatia.manufacturing_interfaces.manufacturing_generator_data import (
...
class ManufacturingOutputGenerator(AnyObject):
    ...
    def init_file_generator(
        self, i_format: str, i_file_name: str, o_data: ManufacturingGeneratorData
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.manufacturing_output_generator.InitFileGenerator(
            i_format, i_file_name, o_data.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
