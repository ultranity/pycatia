...
class ManufacturingPattern(ManufacturingFeature):
    ...
    def add_part_surface(
        self, i_part_surface: AnyObject, i_product: Product, i_notify: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.manufacturing_pattern.AddPartSurface(
            i_part_surface.com_object, i_product.com_object, i_notify
        )
    ...
    def add_position(
        self, i_position: AnyObject, i_product: Product, i_notify: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.manufacturing_pattern.AddPosition(
            i_position.com_object, i_product.com_object, i_notify
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def set_local_tool_axis(
        self, i_point_number: int, i_x: float, i_y: float, i_z: float
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.manufacturing_pattern.SetLocalToolAxis(
            i_point_number, i_x, i_y, i_z
        )
