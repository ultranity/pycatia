...
from pycatia.manufacturing_interfaces.manufacturing_features import (
...
class ManufacturingView(AnyObject):
    ...
    def create_all_machinable_area_features_from_tech_results_of_udf(
        self, i_finish_part_product: Product
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        """
        return (
            self.manufacturing_view.CreateAllMachinableAreaFeaturesFromTechResultsOfUDF(
