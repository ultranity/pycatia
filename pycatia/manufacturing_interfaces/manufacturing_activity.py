...
from pycatia.manufacturing_interfaces.manufacturing_tool_assembly import (
    ManufacturingToolAssembly,
)

if TYPE_CHECKING:
    from pycatia.manufacturing_interfaces.manufacturing_precedences import (
...
class ManufacturingActivity(Activity):
    ...
    def machinable_feature(self) -> ManufacturingMachinableArea:
        ...
        return ManufacturingMachinableArea(
            self.manufacturing_activity.MachinableFeature
        )
    ...
    def get_list_of_feedrate_attributes(self, o_list_of_attributes: tuple) -> None:
        ...
        :rtype: None
        """
        return self.manufacturing_activity.GetListOfFeedrateAttributes(
    ...
    def get_list_of_strategy_attributes(self, o_list_of_attributes: tuple) -> None:
        ...
        :rtype: None
        """
        return self.manufacturing_activity.GetListOfStrategyAttributes(
            o_list_of_attributes
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
    ...
    def get_machining_direction(
        self, o_x_axis: float, o_y_axis: float, o_z_axis: float
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.manufacturing_activity.GetMachiningDirection(
            o_x_axis, o_y_axis, o_z_axis
        )
    ...
    def set_machining_direction(
        self, i_x_axis: float, i_y_axis: float, i_z_axis: float
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.manufacturing_activity.SetMachiningDirection(
            i_x_axis, i_y_axis, i_z_axis
        )
