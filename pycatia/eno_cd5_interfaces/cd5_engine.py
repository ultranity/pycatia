...
class CD5Engine(AnyObject):
    ...
    def connect(
        self, i_user_name: str, i_user_password: str, i_security_context: str
    ) -> None:
        """
        .. note::
            :class: toggle
    ...
    def get_id_from_tnrv(
        self, i_type: str, i_name: str, i_revision: str, i_version: str
    ) -> CD5ID:
        """
        .. note::
            :class: toggle
        ...
        """
        return CD5ID(
            self.cd5_engine.GetIDFromTNRV(i_type, i_name, i_revision, i_version)
        )
