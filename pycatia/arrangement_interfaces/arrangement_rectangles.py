...
class ArrangementRectangles(Collection[ArrangementRectangle]):
    """
    .. note::
        :class: toggle
    ...
    def add_rectangle(
        self, i_rel_axis: Move, i_position: tuple, i_width: float, i_length: float
        ...
        return ArrangementRectangle(
            self.arrangement_rectangles.AddRectangle(
                i_rel_axis.com_object, i_position, i_width, i_length
            )
        )
