...
class ArrangementAreas(Collection[ArrangementArea]):
    """
    .. note::
        :class: toggle
    ...
    def add_area(
        self, i_rel_axis: Move, i_position: tuple, i_height: float
    ) -> ArrangementArea:
        """
        .. note::
            :class: toggle
        ...
        return ArrangementArea(
            self.arrangement_areas.AddArea(i_rel_axis.com_object, i_position, i_height)
        )
