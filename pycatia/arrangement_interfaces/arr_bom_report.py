...
class ArrBomReport(AnyObject):
    ...
    def generate_bom_report(
        self, i_document_to_extract_data: Document, i_output_file_name: str
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.arr_bom_report.GenerateBOMReport(
            i_document_to_extract_data.com_object, i_output_file_name
        )
