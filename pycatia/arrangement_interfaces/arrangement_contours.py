...
class ArrangementContours(Collection[ArrangementContour]):
    """
    .. note::
        :class: toggle
    ...
    def add_rectangular_contour(
        self, i_rectangle: ArrangementRectangle
    ) -> ArrangementContour:
        """
        .. note::
            :class: toggle
        ...
        return ArrangementContour(
            self.arrangement_contours.AddRectangularContour(i_rectangle.com_object)
        )
