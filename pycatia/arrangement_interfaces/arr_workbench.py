...
class ArrWorkbench(Workbench):
    ...
    def convert_arrangement_product_to_product(
        self, i_arr_product: ArrangementProduct
    ) -> Product:
        """
        .. note::
            :class: toggle
        ...
        """
        return Product(
            self.arr_workbench.ConvertArrangementProductToProduct(
                i_arr_product.com_object
            )
        )

    def convert_product_to_arrangement_product(
        self, i_product: Product
    ) -> ArrangementProduct:
        """
        .. note::
            :class: toggle
        ...
        return ArrangementProduct(
            self.arr_workbench.ConvertProductToArrangementProduct(i_product.com_object)
        )
