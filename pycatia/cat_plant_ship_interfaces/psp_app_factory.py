...
class PSPAppFactory(AnyObject):
    ...
    def create_group(
        self, i_current_product: Product, i_group_type: str, i_group_id: str
    ) -> PSPGroup:
        """
        .. note::
            :class: toggle
        ...
        """
        return PSPGroup(
            self.psp_app_factory.CreateGroup(
                i_current_product.com_object, i_group_type, i_group_id
            )
        )
    ...
    def get_compartment(
        self, i_current_product: Product, i_compartment_id: str
    ) -> PSPGroup:
        """
        .. note::
            :class: toggle
        ...
        """
        return PSPGroup(
            self.psp_app_factory.GetCompartment(
                i_current_product.com_object, i_compartment_id
            )
        )

    def get_logical_line(
        self, i_current_product: Product, i_logical_line_id: str
    ) -> PSPLogicalLine:
        """
        .. note::
            :class: toggle
        ...
        return PSPLogicalLine(
            self.psp_app_factory.GetLogicalLine(
                i_current_product.com_object, i_logical_line_id
            )
        )
    ...
    def list_compartments(self, i_current_product: Product) -> PSPListOfObjects:
        ...
        return PSPListOfObjects(
            self.psp_app_factory.ListCompartments(i_current_product.com_object)
        )
    ...
    def list_groups(self, i_current_product: Product) -> PSPListOfObjects:
        ...
        """
        return PSPListOfObjects(
            self.psp_app_factory.ListGroups(i_current_product.com_object)
        )
    ...
    def list_logical_lines(self, i_current_product: Product) -> PSPListOfObjects:
        ...
        """
        return PSPListOfObjects(
            self.psp_app_factory.ListLogicalLines(i_current_product.com_object)
        )

    def list_physicals(
        self, i_current_product: Product, i_domain_id: int
    ) -> PSPListOfObjects:
        """
        .. note::
            :class: toggle
        ...
        """
        return PSPListOfObjects(
            self.psp_app_factory.ListPhysicals(
                i_current_product.com_object, i_domain_id
            )
        )
