...
class PSPWorkbench(AnyObject):
    ...
    def export_properties(
        self, i_document_to_export_from: Document, i_xml_output_file_name: str
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.psp_workbench.ExportProperties(
            i_document_to_export_from.com_object, i_xml_output_file_name
        )
    ...
    def get_interface(self, i_interface_name: str, i_object: AnyObject) -> AnyObject:
        ...
        return AnyObject.new(
            self.psp_workbench.GetInterface(i_interface_name, i_object.com_object)
        )
