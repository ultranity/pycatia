...
class HybridShapeInstance(HybridShape):
    ...
    def get_input(self, i_index: str) -> AnyObject:
        ...
        :rtype: AnyObject
        """
        return AnyObject.new(self.hybrid_shape_instance.GetInput(i_index))
    ...
    def get_input_from_position(self, i_position: int) -> AnyObject:
        ...
        return AnyObject.new(
            self.hybrid_shape_instance.GetInputFromPosition(i_position)
        )
    ...
    def get_output(self, i_name: str) -> AnyObject:
        ...
        :rtype: AnyObject
        """
        return AnyObject.new(self.hybrid_shape_instance.GetOutput(i_name))
    ...
    def get_output_from_position(self, i_position: int) -> AnyObject:
        ...
        """
        return AnyObject.new(
            self.hybrid_shape_instance.GetOutputFromPosition(i_position)
        )
    ...
    def get_parameter(self, i_name: str) -> AnyObject:
        ...
        :rtype: AnyObject
        """
        return AnyObject.new(self.hybrid_shape_instance.GetParameter(i_name))
