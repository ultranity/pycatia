...
class Body(AnyObject):
    ...
    @property
    def hybrid_shapes(self) -> HybridShapes | None:
        """
        .. note::
            :class: toggle
    ...
    @property
    def ordered_geometrical_sets(self) -> OrderedGeometricalSets | None:
        """
        .. note::
            :class: toggle
    ...
    def to_dict(self):
        return super().to_dict() | {
            "hybrid_bodies": self.hybrid_bodies.to_dict(),
            "hybrid_shapes": self.hybrid_shapes.to_dict()
            if self.hybrid_shapes
            else None,
            "in_boolean_operation": self.in_boolean_operation,
            "ordered_geometrical_sets": self.ordered_geometrical_sets.to_dict()
            if self.ordered_geometrical_sets
            else None,
