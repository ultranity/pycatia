...
class InstanceFactory(Factory):
    ...
    def add_instance(self, i_reference: AnyObject) -> AnyObject:
        ...
        :rtype: AnyObject
        """
        return AnyObject.new(self.instance_factory.AddInstance(i_reference.com_object))
    ...
    def get_parameter(self, i_name: str) -> AnyObject:
        ...
        :rtype: AnyObject
        """
        return AnyObject.new(self.instance_factory.GetParameter(i_name))
    ...
    def instantiate(self) -> AnyObject:
        ...
        :rtype: AnyObject
        """
        return AnyObject.new(self.instance_factory.Instantiate())
