...
class EkpServices(AnyObject):
    ...
    def assign_er_with_fta(
        self, i_fta: AnyObject, i_operation: Activity, i_type: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.ekp_services.AssignERWithFTA(
            i_fta.com_object, i_operation.com_object, i_type
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def get_assigned_er(
        self, i_operation: Activity, i_type: int, o_item_list: tuple
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.ekp_services.GetAssignedER(
            i_operation.com_object, i_type, o_item_list
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def remove_er_with_fta(
        ...
        :rtype: None
        """
        return self.ekp_services.RemoveERWithFTA(
            i_fta.com_object, i_operation.com_object, i_type
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
