...
from pycatia.abq_automation_interfaces.abq_solution_step_images import (
    ...
    def create_image(
        ...
        return AnalysisImage(
            self.abq_solution_step.CreateImage(
                i_image_name, i_hide_existing_images, i_incr_or_mode_number
            )
        )

    def set_increment_or_mode_number(
        self, i_incr_or_mode_number: cat_variant, i_image: AnalysisImage
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        return self.abq_solution_step.SetIncrementOrModeNumber(
            i_incr_or_mode_number, i_image.com_object
        )
