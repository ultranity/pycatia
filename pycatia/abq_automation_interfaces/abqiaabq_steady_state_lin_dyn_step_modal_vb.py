...
class ABQIAABQSteadyStateLinDynStepModalVB(ABQIAABQSteadyStateLinDynStepBasicVB):
    ...
    def use_structural_damping_data(self, value: bool):
        ...
        self.abqiaabq_steady_state_lin_dyn_step_modal_vb.UseStructuralDampingData = (
            value
        )

    def add_composite_damping_data_table(
        self, i_column1: tuple, i_column2: tuple
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.abqiaabq_steady_state_lin_dyn_step_modal_vb.AddCompositeDampingDataTable(
            i_column1, i_column2
        )
    ...
    def add_direct_damping_data_table(
        self, i_damping_range: str, i_column1: tuple, i_column2: tuple, i_column3: tuple
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        """
        return (
            self.abqiaabq_steady_state_lin_dyn_step_modal_vb.AddDirectDampingDataTable(
                i_damping_range, i_column1, i_column2, i_column3
            )
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
    ...
    def add_rayleigh_damping_data_table(
        ...
        return self.abqiaabq_steady_state_lin_dyn_step_modal_vb.AddRayleighDampingDataTable(
            i_damping_range, i_column1, i_column2, i_column3, i_column4
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
