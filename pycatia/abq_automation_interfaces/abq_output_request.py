...
class ABQOutputRequest(AnyObject):
    ...
    def add_support_from_product(
        ...
        :rtype: None
        """
        return self.abq_output_request.AddSupportFromProduct(
    ...
    def add_support_from_publication(
        ...
        :rtype: None
        """
        return self.abq_output_request.AddSupportFromPublication(
    ...
    def add_support_from_reference(
        ...
        :rtype: None
        """
        return self.abq_output_request.AddSupportFromReference(
