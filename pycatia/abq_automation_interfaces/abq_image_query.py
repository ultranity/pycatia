...
class ABQImageQuery(AnyObject):
    ...
    def export_group_image_data(
        ...
        :rtype: None
        """
        return self.abq_image_query.ExportGroupImageData(
            i_images_list.com_object, i_group.com_object, i_type, i_file
        )
    ...
    def export_image_data(
        ...
        :rtype: None
        """
        return self.abq_image_query.ExportImageData(
            i_images_list.com_object, i_list_numbers, i_type, i_file
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
