...
class ABQIAABQSteadyStateLinDynStepBasicVB(ABQStep):
    ...
    def boundary_conditions(self) -> ABQBoundaryConditions:
        ...
        return ABQBoundaryConditions(
            self.abqiaabq_steady_state_lin_dyn_step_basic_vb.BoundaryConditions
        )
    ...
    def add_frequency_data_table(
        ...
        return self.abqiaabq_steady_state_lin_dyn_step_basic_vb.AddFrequencyDataTable(
            i_lwr_frequency, i_upr_frequency, i_nb_points, i_bias
        )
    ...
    def add_global_damping(
        self, i_alpha: float, i_beta: float, i_structural: float
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.abqiaabq_steady_state_lin_dyn_step_basic_vb.AddGlobalDamping(
            i_alpha, i_beta, i_structural
        )
