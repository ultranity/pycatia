...
class ABQFilmCondition(ABQLoad):
    ...
    def add_temp_dependent_film_coeff_table(
        self, i_film_coeff: tuple, i_temperature: tuple
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.abq_film_condition.AddTempDependentFilmCoeffTable(
            i_film_coeff, i_temperature
        )
