...
class ABQRigidBodyConstraint(ABQInteraction):
    ...
    def add_support_from_body(self, i_product: Product, i_body: Body) -> None:
        ...
        :rtype: None
        """
        return self.abq_rigid_body_constraint.AddSupportFromBody(
    ...
    def add_support_from_part(self, i_product: Product, i_part: Part) -> None:
        ...
        :rtype: None
        """
        return self.abq_rigid_body_constraint.AddSupportFromPart(
            i_product.com_object, i_part.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def add_support_from_publication(
        ...
        :rtype: None
        """
        return self.abq_rigid_body_constraint.AddSupportFromPublication(
    ...
    def set_handler(self, i_product: Product, i_ref: Reference) -> None:
        ...
        :rtype: None
        """
        return self.abq_rigid_body_constraint.SetHandler(
    ...
    def set_handler_from_publication(
        ...
        :rtype: None
        """
        return self.abq_rigid_body_constraint.SetHandlerFromPublication(
            i_product.com_object, i_publication.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
