...
class ABQAnalyticalRigidSurface(ABQInteraction):
    ...
    def add_support_from_publication(
        ...
        :rtype: None
        """
        return self.abq_analytical_rigid_surface.AddSupportFromPublication(
    ...
    def add_support_from_reference(self, i_product: Product, i_ref: Reference) -> None:
        ...
        :rtype: None
        """
        return self.abq_analytical_rigid_surface.AddSupportFromReference(
    ...
    def set_handler(self, i_product: Product, i_ref: Reference) -> None:
        ...
        :rtype: None
        """
        return self.abq_analytical_rigid_surface.SetHandler(
            i_product.com_object, i_ref.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
    ...
    def set_handler_from_publication(
        ...
        :rtype: None
        """
        return self.abq_analytical_rigid_surface.SetHandlerFromPublication(
            i_product.com_object, i_publication.com_object
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
