...
class ABQDamperConnectionProperty(ABQProperty):
    ...
    def add_support_from_reference(
        ...
        :rtype: None
        """
        return self.abq_damper_connection_property.AddSupportFromReference(
    ...
    def get_non_linear_damping(
        self, i_dof: int, o_force_array: tuple, o_velocity_array: tuple
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.abq_damper_connection_property.GetNonLinearDamping(
            i_dof, o_force_array, o_velocity_array
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
    ...
    def read_damping_data_from_file(self, i_dof: int, i_file_name: str) -> None:
        ...
        :rtype: None
        """
        return self.abq_damper_connection_property.ReadDampingDataFromFile(
            i_dof, i_file_name
        )
    ...
    def set_linear_damping(self, i_dof: int, i_damping_value: float) -> None:
        ...
        :rtype: None
        """
        return self.abq_damper_connection_property.SetLinearDamping(
            i_dof, i_damping_value
        )

    def set_non_linear_damping(
        self, i_dof: int, i_force_array: tuple, i_velocity_array: tuple
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.abq_damper_connection_property.SetNonLinearDamping(
            i_dof, i_force_array, i_velocity_array
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
