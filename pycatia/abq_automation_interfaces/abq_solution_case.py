...
from pycatia.abq_automation_interfaces.abq_solution_case_images import (
...
class ABQSolutionCase(AnyObject):
    ...
    def create_image(
        ...
        return AnalysisImage(
            self.abq_solution_case.CreateImage(
                i_image_name, i_hide_existing_images, i_step_number, i_increment_number
            )
        )
    ...
    def set_step_increment_number(
        ...
        return self.abq_solution_case.SetStepIncrementNumber(
            i_step_number, i_increment_number, i_image.com_object
        )
