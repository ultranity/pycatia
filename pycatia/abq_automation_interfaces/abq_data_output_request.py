...
class ABQDataOutputRequest(ABQOutputRequest):
    ...
    def set_specified_output_variables(
        self, i_variable_name_bstr: str, i_dat_output_var_type: int
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.abq_data_output_request.SetSpecifiedOutputVariables(
            i_variable_name_bstr, i_dat_output_var_type
        )
