...
class ABQOutputRequests(Collection[ABQOutputRequest]):
    """
    .. note::
        :class: toggle
    ...
    def item(
        self, i_index: cat_variant, i_output_request_type: int
    ) -> ABQOutputRequest:
        """
        .. note::
            :class: toggle
        ...
        return ABQOutputRequest(
            self.abq_output_requests.Item(i_index, i_output_request_type)
        )
