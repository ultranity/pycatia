...
class FunctActionsGroup(AnyObject):
    ...
    def get_extremities(
        self, o_input_x: float, o_input_y: float, o_output_x: float, o_output_y: float
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.funct_actions_group.GetExtremities(
            o_input_x, o_input_y, o_output_x, o_output_y
        )
    ...
    def set_extremities(
        self, i_input_x: float, i_input_y: float, i_output_x: float, i_output_y: float
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.funct_actions_group.SetExtremities(
            i_input_x, i_input_y, i_output_x, i_output_y
        )
