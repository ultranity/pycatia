...
class FunctActionsGroups(Collection[FunctActionsGroup]):
    """
    .. note::
        :class: toggle
    ...
    def __init__(self, com_object, child_object=FunctActionsGroup):
        super().__init__(com_object, child_object=child_object)
    ...
    def create(
        ...
        return FunctActionsGroup(
            self.funct_actions_groups.Create(
                i_name, i_input_x, i_input_y, i_output_x, i_output_y
            )
        )
