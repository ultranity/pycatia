...
from pycatia.funct_system_interfaces.functional_object_proxy import (
...
if TYPE_CHECKING:
    from pycatia.funct_system_interfaces.functional_description import (
        FunctionalDescription,
    )


class FunctionalObjects(Collection[FunctionalObject]):
    """
    .. note::
        :class: toggle
    ...
    def create_proxy(
        self, i_name: str, i_desc: "FunctionalDescription"
    ) -> FunctionalObjectProxy:
        """
        .. note::
            :class: toggle
        ...
        return FunctionalObjectProxy(
            self.functional_objects.CreateProxy(i_name, i_desc.com_object)
        )
