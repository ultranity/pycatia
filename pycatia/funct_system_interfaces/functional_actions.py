...
class FunctionalActions(Collection[FunctionalAction]):
    """
    .. note::
        :class: toggle
    ...
    def create(
        self, i_name: str, i_from: FunctionalPosition, i_to: FunctionalPosition
    ) -> FunctionalAction:
        """
        .. note::
            :class: toggle
        ...
        return FunctionalAction(
            self.functional_actions.Create(i_name, i_from.com_object, i_to.com_object)
        )
