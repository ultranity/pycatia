...
class OLPTranslator(AnyObject):
    ...
    def convert_nrl_to_xml(
        self, i_nrl_file_name: str, i_parser_name: str, o_xml_file_name: str
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.olp_translator.ConvertNRLToXML(
            i_nrl_file_name, i_parser_name, o_xml_file_name
        )

    def convert_xml_to_nrl(
        self, i_xml_file_name: str, i_xslt_file_name: str, o_nrl_target_folder: str
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.olp_translator.ConvertXMLToNRL(
            i_xml_file_name, i_xslt_file_name, o_nrl_target_folder
        )
