...
class AssemblyGeneralSettingAtt(SettingController):
    ...
    def get_auto_switch_to_design_mode_info(
        ...
        :rtype: bool
        """
        return self.assembly_general_setting_att.GetAutoSwitchToDesignModeInfo(
    ...
    def get_auto_update_mode_info(self, io_admin_level: str, io_locked: str) -> bool:
        ...
        :rtype: bool
        """
        return self.assembly_general_setting_att.GetAutoUpdateModeInfo(
            io_admin_level, io_locked
        )

    def get_move_with_fix_t_extend_mode_info(
        self, admin_level: str, o_locked: str
    ) -> bool:
        """
        .. note::
        ...
        :rtype: bool
        """
        return self.assembly_general_setting_att.GetMoveWithFixTExtendModeInfo(
            admin_level, o_locked
        )
    ...
    def get_update_status_mode_info(self, admin_level: str, o_locked: str) -> bool:
        ...
        :rtype: bool
        """
        return self.assembly_general_setting_att.GetUpdateStatusModeInfo(
            admin_level, o_locked
        )
