...
class AssemblySplit(AssemblyFeature):
    ...
    def modify_splitting_element(
        self, i_splitting_element: Reference, i_splitting_elem_comp: Product
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        return self.assembly_split.ModifySplittingElement(
            i_splitting_element.com_object, i_splitting_elem_comp.com_object
        )
