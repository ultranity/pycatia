...
class BehaviorSettingAtt(SettingController):
    ...
    def get_bkt_access_rights_info(self, io_admin_level: str, io_locked: str) -> bool:
        ...
        :rtype: bool
        """
        return self.behavior_setting_att.GetBKTAccessRightsInfo(
            io_admin_level, io_locked
        )

    def get_bkt_behavior_operation_message_info(
        ...
        :rtype: bool
        """
        return self.behavior_setting_att.GetBKTBehaviorOperationMessageInfo(
            io_admin_level, io_locked
        )

    def get_bkt_specification_tree_info(
        self, io_admin_level: str, io_locked: str
    ) -> bool:
        """
        .. note::
        ...
        :rtype: bool
        """
        return self.behavior_setting_att.GetBKTSpecificationTreeInfo(
            io_admin_level, io_locked
        )
