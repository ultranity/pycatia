...
class SWKIKConstraint(SWKManikinPart):
    ...
    def set_constraint_element(
        self, pi_constraint_element: AnyObject, pi_constraint_type: str
    ) -> None:
        """
        .. note::
            :class: toggle
        ...
        :rtype: None
        """
        return self.swkik_constraint.SetConstraintElement(
            pi_constraint_element.com_object, pi_constraint_type
        )
    ...
    def set_target_point(
        ...
        :rtype: None
        """
        return self.swkik_constraint.SetTargetPoint(
            pi_object.com_object, pi_coord_x, pi_coord_y, pi_coord_z
        )
        # # # # Autogenerated comment:
        # # some methods require a system service call as the methods expects a vb array object
        # # passed to it and there is no way to do this directly with python. In those cases the following code
