...
class VerifyTabSettingAtt(SettingController):
    ...
    def get_all_resource_filter_info(self, io_admin_level: str, io_locked: str) -> bool:
        ...
        :rtype: bool
        """
        return self.verify_tab_setting_att.GetAllResourceFilterInfo(
    ...
    def get_auto_reframe_filter_info(self, io_admin_level: str, io_locked: str) -> bool:
        ...
        :rtype: bool
        """
        return self.verify_tab_setting_att.GetAutoReframeFilterInfo(
            io_admin_level, io_locked
        )

    def get_implied_resource_filter_info(
        ...
        :rtype: bool
        """
        return self.verify_tab_setting_att.GetImpliedResourceFilterInfo(
            io_admin_level, io_locked
        )
