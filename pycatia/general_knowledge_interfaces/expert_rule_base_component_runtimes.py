...
class ExpertRuleBaseComponentRuntimes(Collection[ExpertRuleBaseComponentRuntime]):
    """
    .. note::
        :class: toggle
    ...
    def item(self, i_index: cat_variant) -> ExpertRuleBaseComponentRuntime:
        ...
        return ExpertRuleBaseComponentRuntime(
            self.expert_rule_base_component_runtimes.Item(i_index)
        )
    ...
    def shallow_item(self, i_index: cat_variant) -> ExpertRuleBaseComponentRuntime:
        ...
        """
        return ExpertRuleBaseComponentRuntime(
            self.expert_rule_base_component_runtimes.ShallowItem(i_index)
        )
