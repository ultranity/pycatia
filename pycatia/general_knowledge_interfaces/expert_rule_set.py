...
from pycatia.general_knowledge_interfaces.expert_rule_set_runtime import (
...
class ExpertRuleSet(ExpertRuleSetRuntime):
    ...
    def create_check(
        self, i_name: str, i_check_variables: str, i_check_body: str, i_rule_set: str
    ) -> ExpertCheck:
        """
        .. note::
            :class: toggle
        ...
        """
        return ExpertCheck(
            self.expert_rule_set.CreateCheck(
                i_name, i_check_variables, i_check_body, i_rule_set
            )
        )

    def create_rule(
        self, i_name: str, i_rule_variables: str, i_rule_body: str, i_rule_set: str
    ) -> ExpertRule:
        """
        .. note::
            :class: toggle
        ...
        """
        return ExpertRule(
            self.expert_rule_set.CreateRule(
                i_name, i_rule_variables, i_rule_body, i_rule_set
            )
        )
